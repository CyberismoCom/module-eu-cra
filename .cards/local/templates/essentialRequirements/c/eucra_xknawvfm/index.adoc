...
The linked secure development task about Security design review includes a review of defence in depth design. This means that the product should be designed in a way that gaining unauthorised access to a function or data does not automatically lead to a complete access to all product functions and data.
